...
export const NavBar = () => {
  ...
  return (
    <nav className="bg-white/90 dark:bg-gray-700 text-gray-800 dark:text-white py-3 px-4 md:px-8 lg:px-[10%] flex justify-between items-center shadow-md relative z-30 transition-colors duration-300">
      {/* Logo */}
